#AUTOGENERATED! DO NOT EDIT! File to edit: dev/01_augment.ipynb (unless otherwise specified).

__all__ = ['RemoveSilence', 'Resample', 'CropSignal', 'SignalShifter', 'AddNoise', 'ChangeVolume', 'SignalCutout',
           'SignalLoss', 'DownmixMono', 'CropTime', 'MaskFreq', 'MaskTime', 'SGRoll', 'Delta', 'TfmResize']
